...
const services = [
  {
    ...
    image: "/can.jpeg?height=400&width=600&text=Candlelight+Dinner+1",
    price: "₹8,000",
  },
  {
    id: "2",
    ...
    image: "/candel.jpeg?height=400&width=600&text=Candlelight+Dinner+2",
    price: "₹10,000",
  },
  {
    id: "3",
    ...
    image: "/roomde.jpeg?height=400&width=600&text=Candlelight+Dinner+3",
    price: "₹6,000",
  },
];

// Define the type for params with an index signature
interface Params {
  [key: string]: string | string[]; // Index signature to handle dynamic route parameters
  category: string; // Explicitly define the `category` property
}
